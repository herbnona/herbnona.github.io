...
function styleCookieCheck() {
    if (document.cookie.indexOf('customtheme') > -1) {
        ...
        if (stylecookie == 'https://herbnona.github.io/graveyard-ghosts.css') {
            swapStyleSheet('https://herbnona.github.io/autumn.css');
            setCookie('customtheme', 'https://herbnona.github.io/autumn.css', 30);
        } else {
